/**
 * Direct unit specs for the per-stage helpers extracted from
 * `Registration.compileDynamicRoute`. Pure projection / validation
 * helpers (collectRouteShape, checkDynamicRouteCaps) are exercised
 * end-to-end here; mutation helpers (ensureSegmentTreeRoot,
 * pushHandler, recordExpansionTerminal) need a BuildState-shaped fixture.
 */
